...
class Game:
    def __init__(self):
        ...
        self.gameboard = {}
        self.placePieces()
        print("----------------------------CHESS PROGRAMME----------------------------")
        print("ENTER MOVE IN ALGEBRIC NOTATION FOR EXAMPLE TO MOVE PAWN e2 to e4 TPYE 'e2 e4':")
        self.main()
    ...
    def placePieces(self):
     ...
     self.gameboard[(3, 0)] = Queen(WHITE, uniDict[WHITE][Queen])
     self.gameboard[(4, 0)] = King(WHITE, uniDict[WHITE][King])
     self.gameboard[(3, 7)] = Queen(BLACK, uniDict[BLACK][Queen])
     self.gameboard[(4, 7)] = King(BLACK, uniDict[BLACK][King])
...
class Pawn(Piece):
    ...
    def availableMoves(self, x, y, gameboard, Color=None):
        ...
        if self.direction == 1: 
            if y == 1:
                if (x, y + 1) not in gameboard and (x, y + 2) not in gameboard:
                    answers.append((x, y + 2))
        ...
        if (x + 1, y + self.direction) in gameboard and gameboard[(x + 1, y + self.direction)].Color != Color:
